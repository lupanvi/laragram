	            ...
	            <div class="row justify-content-center">
	                <div class="col-lg-6">  
	                    <div class="header d-flex justify-content-between align-items-center">
	                        ...
	                        <div>                            
	                            <a class="next" href="#" v-if="step === 1" @click.prevent="step = 2 ">Next</a>
	                            <a class="btn share" :class="inProgress ? 'disabled' : ''" href="#" v-if="step === 2" @click.prevent="share">Share</a>
	                        </div>
	                    </div> 
...
export default{	
	...
	methods:{			
		...
		reset(){
			...
			this.description = '';								
			this.$parent.$el.querySelector('#file').value="";							
		},
		close(){
			this.imageSrc = '';
			this.imageData = '';				
